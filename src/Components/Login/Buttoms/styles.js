...
export const ButtonOption = styled.TouchableOpacity `
    ...
    border-bottom-color : ${props => props.atived ? colors.botao_selecionado_login : colors.background};
`
...
export const TitleButtoms = styled.Text `
    ...
    color : ${props => props.atived ? colors.botao_selecionado_login : colors.botao_deselecionado_login};
    font-weight : 900;
